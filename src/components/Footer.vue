<template>
    <div class="bg-gray-800 py-6 px-4">
        <div class="container mx-auto flex justify-between">
            <div>
                <h1 class="text-red-800 font-bold">CimaMov</h1>
            </div>
            <div class="flex">
                ...
                <a href="#" class="text-gray-300 hover:text-white mr-4">Contact Us</a>
            </div>
            <div class="flex">
                ...
                <a href="#" class="text-red-800 hover:text-white mr-4">
                    <svg class="svg-icon" viewBox="0 0 20 20">
                        <path fill="none"
